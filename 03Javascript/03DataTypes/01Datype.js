...
//  7  primitive data types:
    ...
    // 1.number: integer or floating-point, integers are limited by ±   (2^53-1).
    // 2.bigint :for integer numbers of arbitrary length.
    // 3.string : A string may have zero or more characters
    // 4.boolean :true/false.
    // 5.null : unknown values – a standalone type that has a single value null.
    // 6.undefined : unassigned values – a standalone type that has a single value undefined.
    // 7.symbol : unique identifiers.

// 1 non-primitive data type:
        
    // 8.object : more complex data structures.
